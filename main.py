...
def main(args, wandb=None):
    ...
    if args.model == 'MultiModalModel':
        model = model_module.MultiModalModel(
            img_size=args.model_args['img_size'],
            patch_size=args.model_args['patch_size'],
...
if __name__ == "__main__":
    ...
    arg('--model', '-m', '--m', type=str, 
        choices=['FM', 'FFM', 'DeepFM', 'NCF', 'WDN', 'DCN', 'Image_FM', 'Image_DeepFM', 'Text_FM', 'Text_DeepFM', 'ResNet_DeepFM', 'MultiModalModel'],
